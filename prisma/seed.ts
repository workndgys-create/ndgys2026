...
async function main() {
  ...
  const competitions = [
    ...
    { slug: "bandish", title: "Bandish", category: "Cultural", summary: "A team music showdown — bring your ensemble and perform.", prize: "Rs 25,000", published: true, order: 1, format: "GROUP", feeGroup: 150000, minTeam: 2, maxTeam: 5, registrationOpen: true },
    { slug: "shaam-e-mehfil", title: "Shaam-e-Mehfil", category: "Cultural", summary: "A solo dance showcase.", prize: "Rs 10,000", published: true, order: 2, format: "SOLO", feeSolo: 35000, registrationOpen: true, questionsText: "What is your dance form? (short description)" },
    { slug: "solo-singing", title: "Solo Singing", category: "Cultural", summary: "Take the stage for a three-minute solo performance.", prize: "Rs 10,000", published: true, order: 3, format: "SOLO", feeSolo: 30000, registrationOpen: true },
    { slug: "stock-sense", title: "Stock Sense", category: "Finance", summary: "A solo simulation testing your market instincts.", prize: "Rs 15,000", published: true, order: 4, format: "SOLO", feeSolo: 40000, registrationOpen: true },
    { slug: "greenovation-showdown", title: "Greenovation Showdown", category: "Sustainability", summary: "Team pitch battle for the best sustainability innovation.", prize: "Rs 25,000", published: true, order: 5, format: "GROUP", feeGroup: 120000, minTeam: 2, maxTeam: 5, registrationOpen: true, questionsText: "What is your pitch idea?" },
    { slug: "spark-tank", title: "Spark Tank", category: "Business", summary: "Pitch your startup to a panel of investors, Shark-Tank style.", prize: "Rs 30,000", published: true, order: 6, format: "GROUP", feeGroup: 150000, minTeam: 2, maxTeam: 5, registrationOpen: true, questionsText: "What is your pitch idea?" },
    { slug: "ipl-auction", title: "IPL Auction", category: "Strategy", summary: "Build your dream XI in a fast-paced team auction.", prize: "Rs 20,000", published: true, order: 7, format: "GROUP", feeGroup: 150000, minTeam: 2, maxTeam: 5, registrationOpen: true },
    ...
    { slug: "marketing-mayhem", title: "Marketing Mayhem", category: "Business", summary: "Pitch a campaign — enter solo or as a team.", prize: "Rs 20,000", published: true, order: 9, format: "BOTH", feeSolo: 40000, feeGroup: 150000, minTeam: 2, maxTeam: 5, registrationOpen: true }
  ];
