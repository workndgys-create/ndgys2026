...
export default function FAQClient({ venueRevealed, venueName }: { venueRevealed: boolean; venueName: string }) {
  const faqs: Array<{ cat: string; q: string; a: any }> = [
    { cat: "About", q: "What is the New Delhi Global Youth Summit?", a: "It is a national-level youth diplomacy and leadership summit where students simulate global committees, debate policy, and build skills in research, public speaking and negotiation. NDGYS 4.0 takes place on 22–23 August 2026." },

    { cat: "About", q: "When and where is it taking place?", a: venueRevealed ? `22–23 August 2026 at ${venueName}.` : "22–23 August 2026 — Venue revealed soon." },
