  ...
  if (id) {
    ...
    if (r && r.delegateId) {
      const pdf = await generateBadgePdf({
        ...
        photoData: r.photo?.data
          ? Buffer.from(r.photo.data)
          : undefined,
      ...
      return new NextResponse(
        new Uint8Array(pdf),
        {
          headers: {
            ...
            "Content-Disposition":
              `attachment; filename="badge-${r.delegateId}.pdf`
          }
        }
      );
    }
